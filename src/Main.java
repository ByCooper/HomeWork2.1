...
public class Main {
    public static void main(String[] args) {
                ...
                Pooffinduy sedrick = new Pooffinduy("Sedrick", "Digory", 73, 45, 8, 9, 5);
        ...
        System.out.println();
        Griffindor.getGreatStudentInGriffindor(garry, ron);
        System.out.println();
        Sliserin.getGreatStudentInSliserin(graham, gregory);
        System.out.println();
        Pooffinduy.getGreatStudentInPoofinduy(zahariya, sedrick);
        System.out.println();
